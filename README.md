...
This Porjects uses C, Java and Python to generate a messaging application that uses UDP for message exchange.

> Note that these languages are used in seperate instances
